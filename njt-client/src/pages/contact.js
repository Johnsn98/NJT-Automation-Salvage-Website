...
export class contact extends Component {
    render() {
        ...
        return (
            ...
            <Grid item sm={2} xs={4}>
            <IconButton edge="start" color="inherit" aria-label="menu" href="sms:+1-414-331-5954">
            <PhoneIphoneIcon className={classes.contactIcons} >
            </PhoneIphoneIcon> 
            </IconButton>
            ...
            <Grid item sm={2} xs={4}>        
            <IconButton edge="start" color="inherit" aria-label="menu" href="tel:+1-414-331-5954">
            <PhoneIphoneIcon className={classes.contactIcons}>
                </PhoneIphoneIcon> 
                </IconButton>
            </Grid>
            ...
            <Grid item sm={2} xs={4}>
            <IconButton edge="start" color="inherit" aria-label="menu" href="mailto:nathan@njtautomation.com?Subject=NJT%20INQUIRY">
            ...
            <Grid item sm={2} xs={4}>
            <IconButton edge="start" color="inherit" aria-label="menu" component={Link} to="/location">
            <LocationOnIcon className={classes.contactIcons}>
                </LocationOnIcon>
                </IconButton>
            </Grid>
            </Tooltip>
            ...
            <Grid item sm={2} xs={4}>
            <a style={{ color: 'black' }} href='https://www.google.com/maps/place/NJT+Automation/@43.0571523,-87.9168635,17z/data=!3m1!4b1!4m5!3m4!1s0x8805195c7f83be51:0xe1cb639a25d061!8m2!3d43.0571523!4d-87.9146695'>
