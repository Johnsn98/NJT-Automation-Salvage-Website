					...
					<Grid container direction='row' alignItems='center'>
						<Tooltip title='Send Text Message' placement='right'>
							<Grid item sm={2} xs={4}>
								<IconButton
									...
									<PhoneIphoneIcon
										className={classes.contactIcons}></PhoneIphoneIcon>
								</IconButton>
							</Grid>
						</Tooltip>
						<Tooltip title='Send Text Message'>
							<Grid item sm={10} xs={8}>
								<a href='sms:+1-414-331-5954'>
									<div className={classes.contactText}>TEXT: (414)331-5954</div>
								</a>
							</Grid>
						</Tooltip>
						...
						<Tooltip title='Call NJT'>
							<Grid item sm={10} xs={8}>
								<a href='tel:+1-414-331-5954'>
									<div className={classes.contactText}>CALL: (414)331-5954</div>
								</a>
							</Grid>
						</Tooltip>
						...
						<Tooltip title='Send Email' placement='right'>
							<Grid item sm={2} xs={4}>
								<IconButton
									...
									<MailOutlineIcon
										className={classes.contactIcons}></MailOutlineIcon>
								</IconButton>
							</Grid>
						</Tooltip>
							...
							<Grid item sm={10} xs={8}>
								<div className={classes.contactText}>
									<a href='mailto:nathan@njtautomation.com?Subject=NJT%20INQUIRY'>
										<div className={classes.url}>Nathan@njtautomation.com</div>
									</a>
								</div>
							</Grid>
						</Tooltip>
						...
						<Tooltip title='Location Page' placement='right'>
							<Grid item sm={2} xs={4}>
								<IconButton
									...
									to='/location'>
									<LocationOnIcon
										className={classes.contactIcons}></LocationOnIcon>
								</IconButton>
							</Grid>
						</Tooltip>
						<Tooltip title='Get Directions'>
							<Grid item sm={10} xs={8}>
								<a href='https://www.google.com/maps/place/NJT+Automation/@43.0571523,-87.9168635,17z/data=!3m1!4b1!4m5!3m4!1s0x8805195c7f83be51:0xe1cb639a25d061!8m2!3d43.0571523!4d-87.9146695'>
									<div className={classes.contactText}>
										2025 N Doctor M.L.K. Jr Dr #121, Milwaukee, WI 53212
									</div>
								</a>
							</Grid>
						</Tooltip>
						...
						<Tooltip title='Facebook Page' placement='right'>
							<Grid item sm={2} xs={4}>
								<a
									style={{ color: 'black' }}
									href='https://www.google.com/maps/place/NJT+Automation/@43.0571523,-87.9168635,17z/data=!3m1!4b1!4m5!3m4!1s0x8805195c7f83be51:0xe1cb639a25d061!8m2!3d43.0571523!4d-87.9146695'>
									<IconButton edge='start' color='inherit' aria-label='menu'>
										<FacebookIcon
											className={classes.contactIcons}></FacebookIcon>
									</IconButton>
								</a>
							</Grid>
						</Tooltip>
