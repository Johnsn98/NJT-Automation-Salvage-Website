...
export class sourcing extends Component {
    render() {
        ...
        return (
            ...
            <h1> SPARE AND REPLACEMENT PARTS
            </h1>
            </Link>
            </div>
            ...
            <div className="wanted1">
            <Link to="/contact"  style={{ textDecoration: 'none' }}>
            <h1> NJT will source parts for aging industrial-machines
            </h1>
            </Link>
            </div>
            </div>
